...
public class RegisterPage {
	...
	public void setCreateAssistant(boolean createAssistant) {
		if (createAssistant) loginHandler.getNewUser().getPerson().setAssistant(new Person());
		 else loginHandler.getNewUser().getPerson().setAssistant(null);
	...
	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public boolean isTermsPvisible() {
		return this.termsPvisible;
	}

	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public boolean isRegPvisible() {
		return this.regPvisible;
	}

	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public void setRegPvisible(final boolean regPvisible) {
		this.regPvisible = regPvisible;
	}
