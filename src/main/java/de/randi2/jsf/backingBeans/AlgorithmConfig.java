...
public class AlgorithmConfig {
	...
	public String getSelectedAlgorithmPanelId() {
		...
		if (rand != null) {
			 ...
			 */
			if (rand instanceof CompleteRandomizationConfig) return AlgorithmPanelId.COMPLETE_RANDOMIZATION.toString();
			 else if (rand instanceof BiasedCoinRandomizationConfig) return AlgorithmPanelId.BIASEDCOIN_RANDOMIZATION.toString();
			 else if (rand instanceof TruncatedBinomialDesignConfig) return AlgorithmPanelId.TRUNCATED_RANDOMIZATION.toString();
			 else if (rand instanceof BlockRandomizationConfig) return AlgorithmPanelId.BLOCK_RANDOMIZATION.toString();
			 else if (rand instanceof UrnDesignConfig) return AlgorithmPanelId.URN_MODEL.toString();
			 else if (rand instanceof MinimizationConfig) return AlgorithmPanelId.MINIMIZATION.toString();
			 else if (rand instanceof ResponseAdaptiveRConfig) return AlgorithmPanelId.RESPONSE_ADAPTIVE_RANDOMIZATION.toString();
		}
	...
	public void algorithmChanged(ValueChangeEvent event) {
		 ...
		 * event
		 */
		if (newSelection.equals(selectedAlgorithmPanelId)) return;
		/*
		...
		trialHandler.getCurrentObject().setRandomizationConfiguration(newConfig);
	}
