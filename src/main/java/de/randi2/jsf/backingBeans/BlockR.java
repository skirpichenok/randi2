...
public class BlockR {
	...
	public List<SelectItem> getBlockRandTypes() {
		if (blockRandTypes == null) {
			...
			blockRandTypes.add(new SelectItem(BlockDesignTypeId.CONSTANT_BLOCK.toString(), bundle.getString(BlockRandomizationConfig.class.getCanonicalName() + ".constantBlockSize")));
			blockRandTypes.add(new SelectItem(BlockDesignTypeId.VARIABLE_BLOCK.toString(), bundle.getString(BlockRandomizationConfig.class.getCanonicalName() + ".variableBlockSize")));
		}
	...
	public void setSelectedBlockRandTypes(String selectedBlockRandTypes) {
		...
		if (selectedBlockRandTypes.equals(BlockDesignTypeId.VARIABLE_BLOCK.toString())) {
			renderVariable = true;
		} else renderVariable = false;
	}
	...
	public void minValueChanged(ValueChangeEvent event) {
		...
		if (!renderVariable) {
			if (HtmlInputText.class.cast(event.getSource()).getId().equals("blocksize")) {
				((BlockRandomizationConfig) trialHandler.getCurrentObject().getRandomizationConfiguration()).setMaximum((Integer) event.getNewValue());
			} else {
	...
	public String getSelectedBlockRandTypes() {
		return this.selectedBlockRandTypes;
	}
	...
	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public void setPossitionForSimulation(final int possitionForSimulation) {
		this.possitionForSimulation = possitionForSimulation;
	}
}
