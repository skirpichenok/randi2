...
public class ResponsePropertyConfig extends AbstractSubjectProperty {
	...
	public void addCriterion(ActionEvent event) {
		try {
			...
			criteria.add(new CriterionWrapper<String>((AbstractCriterion<String, ?>) responseCriterion.getClass().newInstance(), loginHandler.getChosenLocale()));
	...
	public ArrayList<CriterionWrapper<? extends Serializable>> getCriteria() {
		...
		if (criteria.isEmpty() && trialHandler.isEditing()) {
			for (AbstractCriterion<? extends Serializable, ? extends AbstractConstraint<?>> c : trialHandler.getCurrentObject().getCriteria()) {
				criteria.add(new CriterionWrapper<Serializable>((AbstractCriterion<Serializable, ?>) c, loginHandler.getChosenLocale()));
			}
		}
		return criteria;
	}
	...
	public DichotomousCriterion getResponseCriterion() {
		return this.responseCriterion;
	}

	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public void setResponseCriterion(final DichotomousCriterion responseCriterion) {
		this.responseCriterion = responseCriterion;
	}
}
