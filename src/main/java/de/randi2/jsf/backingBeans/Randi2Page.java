...
public class Randi2Page {
	@ManagedProperty("#{trialSiteHandler}")
	...
	@ManagedProperty("#{subjectPropertiesConfig}")
	private SubjectPropertiesConfig subjectPropertiesConfig;
	@ManagedProperty("#{algorithmConfig}")
	...
	public TimeZone getZone() {
		if (zone == null) {
			zone = GregorianCalendar.getInstance(loginHandler.getChosenLocale()).getTimeZone();
		}
		return zone;
	}
	...
	public void myTrialSite(ActionEvent event) {
		...
		trialSiteHandler.setCurrentObject(loginHandler.getCurrentUsersTrialSite());
	...
	public void showTrial(ActionEvent event) {
		Trial tTrial = (Trial) (((UIComponent) event.getComponent().getChildren().get(0)).getValueExpression("value").getValue(FacesContext.getCurrentInstance().getELContext()));
	...
	public void showUser(ActionEvent event) {
		Person tPerson = (Person) (((UIComponent) event.getComponent().getChildren().get(0)).getValueExpression("value").getValue(FacesContext.getCurrentInstance().getELContext()));
	...
	public void simulate(ActionEvent event) {
		SimulationHandler simulationHandler = ((SimulationHandler) FacesContext.getCurrentInstance().getApplication().getELResolver().getValue(FacesContext.getCurrentInstance().getELContext(), null, "simulationHandler"));
	...
	public void addTrialSubject(ActionEvent event) {
		if (trialSelected) {
			((TSubjectAdd) FacesContext.getCurrentInstance().getApplication().getELResolver().getValue(FacesContext.getCurrentInstance().getELContext(), null, "tSubjectAdd")).setCurrentTrial(trialHandler.getCurrentObject());
	...
	public void addResponse(ActionEvent event) {
		if (trialSelected) {
			((ResponseAdd) FacesContext.getCurrentInstance().getApplication().getELResolver().getValue(FacesContext.getCurrentInstance().getELContext(), null, "responseAdd")).setCurrentTrial(trialHandler.getCurrentObject());
	...
	public void setTrialSiteHandler(final TrialSiteHandler trialSiteHandler) {
	...
	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public void setSubjectPropertiesConfig(final SubjectPropertiesConfig subjectPropertiesConfig) {
		this.subjectPropertiesConfig = subjectPropertiesConfig;
	}

	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public void setAlgorithmConfig(final AlgorithmConfig algorithmConfig) {
	...
	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public void setActivePanel(final String activePanel) {
	...
	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public void setTrialChangeEffect(final Effect trialChangeEffect) {
		this.trialChangeEffect = trialChangeEffect;
	}
	...
	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public void setTrialSelected(final boolean trialSelected) {
