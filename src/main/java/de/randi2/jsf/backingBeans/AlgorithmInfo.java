...
public class AlgorithmInfo {
	...
	public String getAlgName() {
		...
		return bundle.getString(trialHandler.getCurrentObject().getRandomizationConfiguration().getClass().getCanonicalName() + ".name");
	}

	public String getFurtherDetails() {
		StringBuffer furtherDetails = new StringBuffer();
		ResourceBundle bundle = ResourceBundle.getBundle("de.randi2.jsf.i18n.labels", loginHandler.getChosenLocale());
		ResourceBundle responseBundle = ResourceBundle.getBundle("de.randi2.jsf.i18n.criteria", loginHandler.getChosenLocale());
		...
		if (BlockRandomizationConfig.class.isInstance(currentTrial.getRandomizationConfiguration())) {
			BlockRandomizationConfig conf = BlockRandomizationConfig.class.cast(currentTrial.getRandomizationConfiguration());
			...
			furtherDetails.append("<br//>");
		} else if (ResponseAdaptiveRConfig.class.isInstance(currentTrial.getRandomizationConfiguration())) {
			ResponseAdaptiveRConfig conf = ResponseAdaptiveRConfig.class.cast(trialHandler.getCurrentObject().getRandomizationConfiguration());
			furtherDetails.append("<b>");
	...
	public boolean isStratified() {
		...
		if (t) return t;
		 else return trialHandler.getCurrentObject().isStratifyTrialSite();
	}
	...
	public boolean isStrataFactorsDefined() {
		for (AbstractCriterion<?, ?> c : trialHandler.getCurrentObject().getCriteria()) {
			if (c.getStrata() != null) {
	...
	public List<CriterionWrapper<Serializable>> getStrata() {
		...
		for (AbstractCriterion<? extends Serializable, ? extends AbstractConstraint<? extends Serializable>> c : trialHandler.getCurrentObject().getCriteria()) {
			 ...
			 */
			if (c.getStrata() != null && !c.getStrata().isEmpty()) strata.add(new CriterionWrapper<Serializable>((AbstractCriterion<Serializable, ?>) c, loginHandler.getChosenLocale()));
		}
		return strata;
	}
