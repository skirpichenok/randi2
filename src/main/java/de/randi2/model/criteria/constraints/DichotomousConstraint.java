...
public class DichotomousConstraint extends AbstractConstraint<String> {
	...
	public DichotomousConstraint(List<String> args) throws ConstraintViolatedException {
		super(args);
	}
	...
	protected void configure(List<String> args) throws ConstraintViolatedException {
		if (args == null || args.size() != 1 || args.get(0) == null) throw new ConstraintViolatedException();
	...
	public boolean equals(Object obj) {
		...
		if (expectedValue == null) {
			if (other.expectedValue != null) return false;
		} else if (!expectedValue.equals(other.expectedValue)) return false;
		return true;
	}
